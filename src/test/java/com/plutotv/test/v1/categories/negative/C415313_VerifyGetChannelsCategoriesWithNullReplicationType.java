...
public class C415313_VerifyGetChannelsCategoriesWithNullReplicationType extends BaseTest {
    private final NegativeParamsValidation validationHelper = new NegativeParamsValidation();

    @Test(groups = {"full"})
    public void verifyGetChannelsCategoriesWithNullReplicationType() {
