...
public class C833798_TestV1ActiveRegionsReplicationTypeMandatory extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV1ActiveRegionsReplicationTypeMandatory() {
        ...
        requestParams.put(UPDATED_BEFORE, activeRegionsSteps.getV1RatingsMostRecentlyUpdatedActiveRegionTimestamp());
