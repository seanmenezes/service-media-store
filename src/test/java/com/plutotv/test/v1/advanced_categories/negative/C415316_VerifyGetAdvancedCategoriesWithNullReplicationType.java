...
public class C415316_VerifyGetAdvancedCategoriesWithNullReplicationType extends BaseTest {
    private final NegativeParamsValidation validationHelper = new NegativeParamsValidation();

    @Test(groups = {"full","adv_cat"})
    public void verifyGetAdvancedCategoriesWithNullReplicationType() {
