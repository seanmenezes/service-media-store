...
public class C833939_TestV2ChannelsTimelinesFullSyncUpdatedBeforeMandatory extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncUpdatedBeforeMandatory() {
