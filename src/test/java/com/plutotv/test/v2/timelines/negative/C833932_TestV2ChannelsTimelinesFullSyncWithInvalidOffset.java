...
public class C833932_TestV2ChannelsTimelinesFullSyncWithInvalidOffset extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncWithInvalidOffset() {
        Http400Error expectedError =
                clientErrors.getExpectedHttp400Error(
                        "ValidationFailed: params [Offset] are invalid");
