...
public class C833937_TestV2ChannelsTimelinesFullSyncStartMandatory extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncStartMandatory() {
        Http400Error expectedError =
                clientErrors.getExpectedHttp400Error("ValidationFailed: params [Start] are invalid");
