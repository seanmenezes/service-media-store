...
public class C833924_TestV2ChannelsTimelinesFullSyncEmptyReplicationType extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncEmptyReplicationType() {
        ...
        requestParams.put(REPLICATION_TYPE, EMPTY);
