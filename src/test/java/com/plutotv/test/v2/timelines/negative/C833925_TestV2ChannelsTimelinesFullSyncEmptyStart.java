...
public class C833925_TestV2ChannelsTimelinesFullSyncEmptyStart extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncEmptyStart() {
        ...
        startAndStopParams.put(START, EMPTY);
