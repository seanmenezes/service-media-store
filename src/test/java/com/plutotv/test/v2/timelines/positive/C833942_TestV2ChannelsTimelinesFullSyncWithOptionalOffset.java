...
public class C833942_TestV2ChannelsTimelinesFullSyncWithOptionalOffset extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncWithOptionalOffset() {
        String offset = "1";
        ...
        Response v2ChannelsTimelinesFullSync =
                channelsTimelinesSteps.getV2ChannelsTimelinesFullSync(syncStop, timeRange);
        ...
        Response v2ChannelsTimelinesFullSyncWithOffset =
                channelsTimelinesSteps.getV2ChannelsTimelinesFullSyncWithOffset(offset, syncStop, timeRange);
