...
public class C833927_TestV2ChannelsTimelinesFullSyncInvalidStart extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncInvalidStart() {
        ...
        startAndStopParams.put(START, "Invalid");
