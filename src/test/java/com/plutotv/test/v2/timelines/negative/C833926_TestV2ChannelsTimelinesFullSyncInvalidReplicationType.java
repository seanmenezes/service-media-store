...
public class C833926_TestV2ChannelsTimelinesFullSyncInvalidReplicationType extends BaseTest {
    ...
    @Test(groups = {"full"})
    public void testV2ChannelsTimelinesFullSyncNullReplicationType() {
        Http400Error expectedError =
                clientErrors.getExpectedHttp400Error(
                        "ValidationFailed: params [ReplicationType] are invalid");

        Map<String, String> requestParams = new HashMap<>();
        requestParams.put(REPLICATION_TYPE, "invalid");
